...
--
-- Host: localhost:3306
-- Generation Time: May 18, 2022 at 01:23 AM
...
--
ALTER TABLE `rev`
  ADD CONSTRAINT `rev_ibfk_1` FOREIGN KEY (`gym_id`) REFERENCES `gym_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
